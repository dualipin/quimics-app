  ...
  <div class="overflow-hidden">
    <div class="mx-auto flex max-w-3xl flex-col gap-4 p-4">
      ...
      <div v-if="selectedElements.length > 0" class="mt-4 flex flex-wrap gap-2">
        ...
        <span v-for="(element, index) in selectedElements" :key="index"
...
const score = ref(0)
// Tiempo por compuesto (en segundos) -> 60s = 1 minuto
...
function nextCompound() {
  ...
  // Reinicia el temporizador a 60 segundos para el siguiente compuesto
  timeLeft.value = 60
}
