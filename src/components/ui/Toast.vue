...
const toastClasses = computed(() =>
  clsx(
    ...
    props.type === 'error' && 'bg-red-200/50 text-red-500 dark:bg-red-950/20 dark:text-red-200',
    props.type === 'info' && 'bg-blue-200/50 text-blue-500 dark:bg-blue-950/20 dark:text-blue-200',
  ),
)
